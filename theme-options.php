...
/////////////////////////////////////////////////////////////////////
// Add Gieroj Theme Options to the Appearance Menu and Admin Bar
////////////////////////////////////////////////////////////////////

    function dmbs_theme_options_menu() {
        add_theme_page( 'Gieroj Theme' . __('Options','gierojbootstrap3'), 'Gieroj' . __('Options','gierojbootstrap3'), 'manage_options', 'gieroj-theme-options', 'gieroj_theme_options' );
    }
    ...
    function toolbar_link_to_dmbs_options( $wp_admin_bar ) {
        $args = array(
            'id'    => 'gieroj_theme_options',
            'title' => __('Gieroj Options','gierojbootstrap3'),
            'href'  => home_url() . '/wp-admin/themes.php?page=gieroj-theme-options',
            'meta'  => array( 'class' => 'gieroj-theme-options' ),
            'parent' => 'site-name'
        );
...
////////////////////////////////////////////////////////////////////
    ...
    function gieroj_theme_style() {
        wp_enqueue_style('gieroj-theme', get_template_directory_uri() . '/css/admin.css');
    }
    add_action('admin_enqueue_scripts', 'gieroj_theme_style');
...
////////////////////////////////////////////////////////////////////
    ...
    register_default_headers( array(
        'wheel' => array(
            ...
            'description' => __( 'Your Business Name', 'gierojbootstrap' )
        ))
    ...
    $defaults = array(
        ...
        'wp-head-callback'       => '',
        'admin-head-callback'    => '',
        'admin-preview-callback' => 'gieroj_admin_header_image',
    );
    add_theme_support( 'custom-header', $defaults );

    function gieroj_admin_header_image() { ?>
...
////////////////////////////////////////////////////////////////////
    ...
    if ( !current_user_can( 'manage_options' ) )  {
        ...
        //get our logo
        $logo = get_template_directory_uri() . '/img/favicon.png'; ?>

        <div class="wrap">

        <div class="dm-logo-wrap"><a href="<?php echo $developer_uri ?>" target="_blank"><img src="<?php echo $logo; ?>" class="dm-logo" title="Created by Pawel Gawron @ nicemodern.website" /></a></div>

            <div class="icon32" id="icon-options-general"></div>

            <h2><a href="<?php echo $developer_uri ?>" target="_blank">GierojBootstrap3</a></h2>
               ...
               <div class='saved'><p><strong><?php _e('Options Saved!','gierojbootstrap3') ;?></strong></p></div>
            ...
            <form action="options.php" method="post">
                ...
                <table cellpadding='10'>
                    ...
                    <tr valign="top"><th scope="row"><?php _e('Right Sidebar','gierojbootstrap3') ;?></th>
                        <td>
                            <input type="checkbox" id="right_sidebar" name="dm_options[right_sidebar]" value="1" <?php checked( true, $settings['right_sidebar'] ); ?> />
                            <label for="right_sidebar"><?php _e('Show the Right Sidebar','gierojbootstrap3') ;?></label>
                        </td>
                    </tr>

                    <tr valign="top"><th scope="row"><?php _e('Right Sidebar Size','gierojbootstrap3') ;?></th>
                        <td>
                    ...
                    <tr valign="top"><th scope="row"><?php _e('Left Side Bar','gierojbootstrap3') ;?></th>
                        <td>
                            <input type="checkbox" id="left_sidebar" name="dm_options[left_sidebar]" value="1" <?php checked( true, $settings['left_sidebar'] ); ?> />
                            <label for="left_sidebar"><?php _e('Show the Left Sidebar','gierojbootstrap3') ;?></label>
                        </td>
                    </tr>

                    <tr valign="top"><th scope="row"><?php _e('Left Sidebar Size','gierojbootstrap3') ;?></th>
                        <td>
                            <?php foreach( $dm_sidebar_sizes as $sizes ) : ?>
                    ...
                    <tr valign="top"><th scope="row"><?php _e('Show Header','gierojbootstrap3') ;?></th>
                        <td>
                            <input type="checkbox" id="show_header" name="dm_options[show_header]" value="1" <?php checked( true, $settings['show_header'] ); ?> />
                            <label for="show_header"><?php _e('Show The Main Header in the Template (logo/sitename/etc.)','gierojbootstrap3') ;?></label>
                        </td>
                    </tr>
                    
                    <tr valign="top"><th scope="row"><?php _e('Show Slider','gierojbootstrap3') ;?></th>
                        <td>
                            <input type="checkbox" id="show_slider" name="dm_options[show_slider]" value="1" <?php checked( true, $settings['show_slider'] ); ?> />
                            <label for="show_slider"><?php _e('Show Slider','gierojbootstrap3') ;?></label>
                        </td>
                    </tr>

                    <tr valign="top"><th scope="row"><?php _e('Show Post Meta','gierojbootstrap3') ;?></th>
                        <td>
                            <input type="checkbox" id="show_postmeta" name="dm_options[show_postmeta]" value="1" <?php checked( true, $settings['show_postmeta'] ); ?> />
                            <label for="show_postmeta"><?php _e('Show Post Meta data (author, category, date created)','gierojbootstrap3') ;?></label>
                        </td>
                    </tr>

                    <tr valign="top"><th scope="row"><?php _e('Give Danny His Credit?','gierojbootstrap3') ;?></th>
                        <td>
                            <input type="checkbox" id="author_credits" name="dm_options[author_credits]" value="1" <?php checked( true, $settings['author_credits'] ); ?> />
                            <label for="author_credits"><?php _e('Show me some love and keep a link to Gieroj.com in your footer.','gierojbootstrap3') ;?></label>
                        </td>
                    </tr>
                ...
                <p class="submit">
                    <input name="Submit" type="submit" class="button-primary" value="<?php esc_attr_e('Save Changes','gierojbootstrap3'); ?>" />
                </p>
